...
def get_page():
    ...
    for i in range(len(block)):
        ...
        result.append({'date':date,'reply':reply, 'retweet':retweet, 'like':like})
...
# 중복제거
result = list(map(dict, collections.OrderedDict.fromkeys(tuple(sorted(d.items())) for d in result)))
